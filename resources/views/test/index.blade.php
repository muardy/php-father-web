...
<head>
	...
	<link rel="stylesheet" href="app-assets/css/carousel.css">
                            ...
                            <ul class="list-inline text-right navbar-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#"><img src="images/de.png" alt=""> Germanaaaaaaaa</a></li>
                                    </ul>
                                </li>
				...
				<nav class="navbar navbar-default yamm">
				    <div class="container-fluid">
				        <div class="navbar-header">
							...
							<a class="navbar-brand" href="index.blade.php"><img src="images/logo.png" alt="Linda"></a>
				        </div>
				        <div id="navbar" class="navbar-collapse collapse">
				            <ul class="nav navbar-nav navbar-right">
						                ...
						                <li>
						                    <div class="yamm-content">
							                    <div class="row"> 
							                    	<div class="col-md-4">
														<ul>
							                    			<li><a href="service-01.blade.php">SEO Consultants</a></li>
							                    			<li><a href="service-02.blade.php">SEO Audits</a></li>
							                    			<li><a href="service-03.blade.php">SEO Packages & Plans</a></li>
							                    			<li><a href="service-04.blade.php">Web Copywriting</a></li>
							                    			<li><a href="service-05.blade.php">SEO Copywriting</a></li>
							                    			<li><a href="service-06.blade.php">Keyword Research</a></li>
							                    			<li><a href="service-07.blade.php">SEO Strategy</a></li>
							                    			<li><a href="service-08.blade.php">Website Design</a></li>
							                    			<li><a href="service-09.blade.php">Link Building Services</a></li>
							                    		</ul>
							                    	</div>
							                    	<div class="col-md-4">
														<ul>
							                    			<li><a href="page-services.blade.php">All Services</a></li>
							                    			<li><a href="page-pricing.blade.php">Pricing & Plans</a></li>
							                    			<li><a href="page-clients.blade.php">Our Clients</a></li>
							                    			<li><a href="page-testimonials.blade.php">Testimonials</a></li>
							                    			<li><a href="page-ebooks.blade.php">Free E-Books</a></li>
							                    			<li><a href="page-seo-analysis.blade.php">SEO Analysis</a></li>
							                    			<li><a href="case-studies.blade.php">Case Studies</a></li>
							                    			<li><a href="case-studies-alt.blade.php">Case Studies Alt</a></li>
							                    			<li><a href="case-studies-single.blade.php">Case Studies Single</a></li>
							                    		</ul>
							                    	</div>
							                    	<div class="col-md-4">
														<ul>
							                    			<li><a href="blog.blade.php">Blog & News</a></li>
							                    			<li><a href="blog-alt.blade.php">Blog Alternative</a></li>
							                    			<li><a href="blog-single.blade.php">Single Blog</a></li>
							                    			<li><a href="page.blade.php">Default Page</a></li>
							                    			<li><a href="page-fullwidth.blade.php">Fullwidth Page</a></li>
							                    			<li><a href="page-contact.blade.php">Contact us</a></li>
							                    			<li><a href="page-contact-alt.blade.php">Contact Alternative</a></li>
							                    			<li><a href="page-faqs.blade.php">FAQ's Page</a></li>
							                    			<li><a href="page-not-found.blade.php">404 Not Found</a></li>
							                    		</ul>
							                    	</div>
							                    </div>
						                    </div>
				                ...
				                <li><a href="page-about.blade.php">What is SEO?</a></li>
				                <li><a href="case-studies.blade.php">Case Studies</a></li>
				                <li><a href="blog.blade.php">Blog</a></li>
				                <li><a href="page-contact.blade.php">Contact</a></li>
                                <li class="lastlink hidden-xs hidden-sm"><a class="btn btn-primary" href="page-seo-analysis.blade.php"><i class="glyphicon glyphicon-search"></i> free seo analysis</a></li>
                            </ul>
				        </div><!--/.nav-collapse -->
				    </div><!--/.container-fluid -->
				</nav><!-- end nav -->
				...
				<div class="row service-list text-center">
					<div class="col-md-4 col-sm-12 col-xs-12 first">
						<div class="service-wrapper wow fadeIn">	
							...
							<div class="service-details">
								<h4><a href="service-01.blade.php" title="">What We Do</a></h4>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="service-wrapper wow fadeIn">	
							...
							<div class="service-details">
								<h4><a href="service-02.blade.php" title="">Who We Are</a></h4>
					...
					<div class="col-md-4 col-sm-12 col-xs-12 last">
						<div class="service-wrapper wow fadeIn">	
							...
							<div class="service-details">
								<h4><a href="service-02.blade.php" title="">Our Mission</a></h4>
				...
				<div class="owl-carousel owl-theme lightcasestudies withhover">
					<div class="item-carousel">
						<div class="case-box">
							...
							<div class="magnifier">
								<a href="case-studies-single.blade.php"><i class="fa fa-link"></i></a> 
							</div>
						</div><!-- end case-box -->
					</div><!-- end col -->
